...
async def register_student(details: StudentRegistration, db=Depends(get_db1)):
    ...
    cursor.execute(insert_query, (
        ...
        details.BloodGroup, details.MedicalDisability, json.dumps(details.Documents), json.dumps(details.PaymentDetails),
        details.Password, user_id, details.ParentOccupation, details.ParentQualification
    ))
